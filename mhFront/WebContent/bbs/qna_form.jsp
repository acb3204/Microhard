...
String ql_qdate = "", ql_adate = "", ql_title = "", ql_content = "", ql_ip = "", ql_isanswer = "n";
...
if (kind.equals("up")) {	// 게시글 수정 폼일 경우
	...
	try {
		...
		if (rs.next()) {	// 게시글이 있으면
			...
			ql_content = rs.getString("ql_content");
...
<tr><th>글제목</th><td colspan="3">	<input type="text" name="ql_title" size="60" value="<%=ql_title %>" /></td></tr>
<tr><th>글내용</th><td colspan="3">	<textarea name="ql_content" cols="65" rows="10"><%=ql_content %></textarea></td></tr>
