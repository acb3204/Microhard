...
String where =" where ql_isview = 'y' and mi_nick = '" + loginInfo.getMi_nick() + "'";
...
if (rs.next()) {
	...
	do { 
		...
		title = "<a href='qna_list_view.jsp?idx=" + rs.getInt("ql_idx") + "&cpage=" + cpage + "'>" + title + "</a>";
...
<td width="*" align="right">
	<input type="button" value="글등록" onclick="location.href='qna_form.jsp?kind=in';" />
</td>
</tr>
</table>
</div>
