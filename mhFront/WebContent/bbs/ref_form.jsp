...
String rl_title = "", rl_content =  "", rl_isview = "n",  rl_name = "";
...
<th>글내용</th>
	...
	현 <%=caption %>하는 자료실을
 	<input type="radio" name="rl_isview" value="n" id="vn" <% if (rl_isview.equals("n")) {%> checked="cheked" <%} %>/>
	<label for="vn">미게시</label>&nbsp;
	 <input type="radio" name="rl_isview" value="y" id="vy" <% if (rl_isview.equals("y")) {%> checked="cheked" <%} %>/>
