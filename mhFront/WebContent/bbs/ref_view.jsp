...
<tr><th>첨부파일</th>
<td colspan="3">
<% if (isLogin) { %><a href="file_download.jsp?file=<%=rl_name %>" 
onmouseover="this.style.color='blue'" onmouseout="this.style.color='white'" ><%=rl_name %></a> 
<% } else { %>
<a href="../login_form.jsp" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'">회원만 다운로드가 가능합니다  </a>
<% } %>
</td></tr>
