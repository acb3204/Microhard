...
if (rs.next()) {
	...
	do {
		...
		if (title.length() > 20) {
			...
			title2 = "<a href='notice_view_front.jsp?idx=" + rs.getInt("nl_idx") + "&cpage=" + cpage + schargs + "'";
...
<%
if (rcnt >0) {
	String link = "notice_list_front.jsp?cpage=";
	if (cpage == 1) {
		out.println("[처음]&nbsp;&nbsp;&nbsp;[이전]&nbsp;&nbsp;");
	} else {
...
<tr><td colspan="2">
	...
	<fieldset>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" value="전체 글보기" onclick="location.href='notice_list_front.jsp';" />
	</fieldset>
	</form>
</td></tr>
</table>
