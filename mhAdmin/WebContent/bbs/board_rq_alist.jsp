...
if (kind.equals("bap")) {
	where += " AND br_isanswer = 'a' ";
} else if (kind.equals("app")) {
	where += " AND br_isanswer = 'b' ";
} else if (kind.equals("nap")) {
	where += " AND br_isanswer = 'c' ";
}
...
try {
	...
	if (kind.equals("bap")) {
		sql += " WHERE br_isanswer = 'a' ";
	} else if (kind.equals("app")) {
		sql += " WHERE br_isanswer = 'b' ";
	} else if (kind.equals("nap")) {
		sql += " WHERE br_isanswer = 'c' ";
	}
...
<tr align="left">
	<th>
		<button onclick="location.href='board_rq_alist.jsp'">전체</button>
		<button onclick="location.href='board_rq_alist.jsp?kind=bap'">승인전</button>
		<button onclick="location.href='board_rq_alist.jsp?kind=app'">승인</button>
		<button onclick="location.href='board_rq_alist.jsp?kind=nap'">반려</button>
	</th>
</tr>
</table>
