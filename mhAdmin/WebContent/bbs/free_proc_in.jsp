...
if (isLogin) {
	fl_ismem = "y";
	fl_writer = loginInfo.getAi_name();
}
...
try {
	...
	sql = "insert into t_free_list (fl_idx, fl_ismem, fl_writer, fl_title, fl_content, fl_ip)  values (?, ?, ?, ?, ?, ?)";

	PreparedStatement pstmt = conn.prepareStatement(sql);
	// System.out.println(pstmt);
	pstmt.setInt(1, idx);			pstmt.setString(2, fl_ismem);
	pstmt.setString(3, fl_writer);	pstmt.setString(4, fl_title);	
	pstmt.setString(5, fl_content);	pstmt.setString(6, fl_ip);		
