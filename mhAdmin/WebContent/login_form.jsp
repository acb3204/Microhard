...
<div align="right">
<% if (isLogin) { %>
<%=loginInfo.getAi_name() %>님 환영합니다.<br />
<% } %>
</div>
<%
...
<form name="frmLogin" action="login_proc.jsp" method="post">
	<div style="background:black; margin:20px -0.5% 0px -20px; text-align:center; height:400px; border: 1px solid; font-size: 150%;  box-sizing: border-box;">
		...
		아이디 &nbsp;&nbsp;&nbsp;<input type="text" name="ai_id" placeholder="아이디 입력" value="" maxlength="20" style="height:30px;" text-align="center" font-weight="bold;"  /><br />
		<br />
		비밀번호 <input type="password" name="ai_pw" placeholder="비밀번호 입력" value="" maxlength="20"  style="height:30px;" text-align="center" font-weight="bold;" /><br />
